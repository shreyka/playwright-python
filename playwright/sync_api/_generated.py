...
class Request(SyncBase):
    ...
    def header_value(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.header_value(name=name)))
...
class Response(SyncBase):
    ...
    def header_values(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.header_values(name=name)))
...
class Route(SyncBase):
    ...
    def abort(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.abort(errorCode=error_code)))
    ...
    def fulfill(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.fulfill(status=status,
    ...
    def fetch(self,
        ...
        **Details**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.fetch(url=url,
                                                  method=method,
                                                  headers=mapping.to_impl(headers),
    ...
    def fallback(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.fallback(url=url,
                                                           method=method,
                                                           headers=mapping.to_impl(headers),
                                                           postData=mapping.to_impl(post_data))))
    ...
    def continue_(self,
        ...
        **NOTE** The `Cookie` header cannot be overridden using this method. If a value is provided, it will be ignored,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.continue_(url=url,
                                                            method=method,
                                                            headers=mapping.to_impl(headers),
                                                            postData=mapping.to_impl(post_data))))
...
class WebSocket(SyncBase):
    ...
    @typing.overload
    def on(self, event: Literal['close'], f: typing.Callable[['WebSocket'], 'None']) -> None:
        """
        Fired when the websocket closes."""

    @typing.overload
    def on(self, event: Literal['framereceived'], f: typing.Callable[['typing.Union[bytes, str]'], 'None']) -> None:
        """
        Fired when the websocket receives a frame."""

    @typing.overload
    def on(self, event: Literal['framesent'], f: typing.Callable[['typing.Union[bytes, str]'], 'None']) -> None:
        """
        Fired when the websocket sends a frame."""

    @typing.overload
    def on(self, event: Literal['socketerror'], f: typing.Callable[['str'], 'None']) -> None:
        """
    ...
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['WebSocket'], 'None']) -> None:
        """
        Fired when the websocket closes."""

    @typing.overload
    def once(self, event: Literal['framereceived'], f: typing.Callable[['typing.Union[bytes, str]'], 'None']) -> None:
        """
        Fired when the websocket receives a frame."""

    @typing.overload
    def once(self, event: Literal['framesent'], f: typing.Callable[['typing.Union[bytes, str]'], 'None']) -> None:
        """
        Fired when the websocket sends a frame."""

    @typing.overload
    def once(self, event: Literal['socketerror'], f: typing.Callable[['str'], 'None']) -> None:
        """
        Fired when the websocket has an error."""
    ...
    def expect_event(self,
                     ...
                     *,
                     timeout: typing.Optional[float] = None) -> EventContextManager:
    ...
    def wait_for_event(self,
        ...
        **NOTE** In most cases, you should use `web_socket.expect_event()`.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for_event(event=event,
                                                                 predicate=self._wrap_handler(predicate),
                                                                 timeout=timeout)))
...
class WebSocketRoute(SyncBase):
    ...
    def close(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.close(code=code,
                                                        reason=reason)))
...
class Keyboard(SyncBase):
    ...
    def insert_text(self,
        ...
        **NOTE** Modifier keys DO NOT effect `keyboard.insertText`. Holding down `Shift` will not type the text in upper
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.insert_text(text=text)))
    ...
    def type(self,
        ...
        **NOTE** For characters that are not on a US keyboard, only an `input` event will be sent.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.type(text=text,
                                                       delay=delay)))
    ...
    def press(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.press(key=key,
                                                        delay=delay)))
...
class Mouse(SyncBase):
    ...
    def move(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.move(x=x,
                                                       y=y,
                                                       steps=steps)))
    ...
    def down(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.down(button=button,
    ...
    def up(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.up(button=button,
                                                     clickCount=click_count)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.click(x=x,
                                                        y=y,
                                                        delay=delay,
                                                        button=button,
                                                        clickCount=click_count)))
    ...
    def dblclick(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dblclick(x=x,
                                                           y=y,
                                                           delay=delay,
                                                           button=button)))
    ...
    def wheel(self,
        ...
        **NOTE** Wheel events may cause scrolling if they are not handled, and this method does not wait for the scrolling
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wheel(deltaX=delta_x,
                                                        deltaY=delta_y)))
...
class Touchscreen(SyncBase):
    ...
    def tap(self,
        ...
        **NOTE** `page.tap()` the method will throw if `hasTouch` option of the browser context is false.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.tap(x=x,
                                                      y=y)))
...
class JSHandle(SyncBase):
    ...
    def evaluate(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.evaluate(expression=expression,
    ...
    def evaluate_handle(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.evaluate_handle(expression=expression,
                                                            arg=mapping.to_impl(arg))))
    ...
    def get_property(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.get_property(propertyName=property_name)))
...
class ElementHandle(JSHandle):
    ...
    def get_attribute(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.get_attribute(name=name)))
    ...
    def dispatch_event(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dispatch_event(type=type,
    ...
    def scroll_into_view_if_needed(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.scroll_into_view_if_needed(timeout=timeout)))
    ...
    def hover(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.hover(modifiers=mapping.to_impl(modifiers),
                                                        position=position,
                                                        timeout=timeout,
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.click(modifiers=mapping.to_impl(modifiers),
                                                        position=position,
                                                        delay=delay,
                                                        button=button,
                                                        clickCount=click_count,
    ...
    def dblclick(self,
        ...
        **NOTE** `elementHandle.dblclick()` dispatches two `click` events and a single `dblclick` event.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dblclick(modifiers=mapping.to_impl(modifiers),
                                                           position=position,
                                                           delay=delay,
                                                           button=button,
                                                           timeout=timeout,
    ...
    def select_option(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.select_option(value=mapping.to_impl(value),
    ...
    def tap(self,
        ...
        **NOTE** `elementHandle.tap()` requires that the `hasTouch` option of the browser context be set to true.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.tap(modifiers=mapping.to_impl(modifiers),
                                                      position=position,
                                                      timeout=timeout,
                                                      force=force,
                                                      noWaitAfter=no_wait_after,
    ...
    def fill(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.fill(value=value,
                                                       timeout=timeout,
                                                       noWaitAfter=no_wait_after,
                                                       force=force)))
    ...
    def select_text(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.select_text(force=force,
                                                              timeout=timeout)))
    ...
    def input_value(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.input_value(timeout=timeout)))
    ...
    def set_input_files(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_input_files(files=mapping.to_impl(files),
                                                                  timeout=timeout,
                                                                  noWaitAfter=no_wait_after)))
    ...
    def set_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_checked(checked=checked,
                                                              position=position,
                                                              timeout=timeout,
                                                              force=force,
                                                              noWaitAfter=no_wait_after,
    ...
    def check(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.check(position=position,
                                                        timeout=timeout,
                                                        force=force,
                                                        noWaitAfter=no_wait_after,
                                                        trial=trial)))
    ...
    def uncheck(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.uncheck(position=position,
                                                          timeout=timeout,
                                                          force=force,
                                                          noWaitAfter=no_wait_after,
                                                          trial=trial)))
    ...
    def screenshot(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.screenshot(timeout=timeout,
                                                             type=type,
                                                             path=path,
                                                             quality=quality,
    ...
    def query_selector(self,
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.query_selector(selector=selector)))
    ...
    def query_selector_all(self,
        ...
        return mapping.from_impl_list(self._sync(self._impl_obj.query_selector_all(selector=selector)))
    ...
    def eval_on_selector(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.eval_on_selector(selector=selector,
    ...
    def eval_on_selector_all(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.eval_on_selector_all(selector=selector,
                                                                       expression=expression,
                                                                       arg=mapping.to_impl(arg))))
    ...
    def wait_for_element_state(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for_element_state(state=state,
                                                                         timeout=timeout)))
    ...
    def wait_for_selector(self,
        ...
        **NOTE** This method does not work across navigations, use `page.wait_for_selector()` instead.
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.wait_for_selector(selector=selector,
                                                                       state=state,
                                                                       timeout=timeout,
                                                                       strict=strict)))
...
class Accessibility(SyncBase):
    ...
    def snapshot(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.snapshot(interestingOnly=interesting_only,
...
class FileChooser(SyncBase):
    ...
    def set_files(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_files(files=mapping.to_impl(files),
                                                            timeout=timeout,
                                                            noWaitAfter=no_wait_after)))
...
class Frame(SyncBase):
    ...
    def goto(self,
        ...
        **NOTE** Headless mode doesn't support navigation to a PDF document. See the
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.goto(url=url,
                                                          timeout=timeout,
    ...
    def expect_navigation(self,
                          *,
                          ...
                          wait_until: typing.Optional[Literal['commit', 'domcontentloaded', 'load', 'networkidle']] = None,
                          timeout: typing.Optional[float] = None) -> EventContextManager["Response"]:
    ...
    def wait_for_url(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for_url(url=self._wrap_handler(url),
                                                               waitUntil=wait_until,
                                                               timeout=timeout)))
    ...
    def wait_for_load_state(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for_load_state(state=state,
                                                                      timeout=timeout)))
    ...
    def is_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_checked(selector=selector,
                                                             strict=strict,
                                                             timeout=timeout)))
    ...
    def is_disabled(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_disabled(selector=selector,
                                                              strict=strict,
                                                              timeout=timeout)))
    ...
    def is_editable(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_editable(selector=selector,
                                                              strict=strict,
                                                              timeout=timeout)))
    ...
    def is_enabled(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_enabled(selector=selector,
                                                             strict=strict,
                                                             timeout=timeout)))
    ...
    def is_hidden(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_hidden(selector=selector,
                                                            strict=strict,
                                                            timeout=timeout)))
    ...
    def is_visible(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_visible(selector=selector,
                                                             strict=strict,
                                                             timeout=timeout)))
    ...
    def dispatch_event(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dispatch_event(selector=selector,
                                                                 type=type,
                                                                 eventInit=mapping.to_impl(event_init),
                                                                 strict=strict,
                                                                 timeout=timeout)))
    ...
    def set_content(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_content(html=html,
                                                              timeout=timeout,
                                                              waitUntil=wait_until)))
    ...
    def add_script_tag(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.add_script_tag(url=url,
                                                           path=path,
                                                           content=content,
                                                           type=type)))
    ...
    def add_style_tag(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.add_style_tag(url=url,
                                                          path=path,
                                                          content=content)))
    ...
    def click(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.click(selector=selector,
    ...
    def dblclick(self,
        ...
        **NOTE** `frame.dblclick()` dispatches two `click` events and a single `dblclick` event.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dblclick(selector=selector,
                                                           modifiers=mapping.to_impl(modifiers),
                                                           position=position,
                                                           delay=delay,
                                                           button=button,
    ...
    def tap(self,
        ...
        **NOTE** `frame.tap()` requires that the `hasTouch` option of the browser context be set to true.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.tap(selector=selector,
                                                      modifiers=mapping.to_impl(modifiers),
                                                      position=position,
                                                      timeout=timeout,
                                                      force=force,
    ...
    def fill(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.fill(selector=selector,
                                                       value=value,
                                                       timeout=timeout,
                                                       noWaitAfter=no_wait_after,
                                                       strict=strict,
    ...
    def focus(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.focus(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout)))
    ...
    def text_content(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.text_content(selector=selector,
                                                               strict=strict,
                                                               timeout=timeout)))
    ...
    def inner_text(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.inner_text(selector=selector,
                                                             strict=strict,
                                                             timeout=timeout)))
    ...
    def inner_html(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.inner_html(selector=selector,
                                                             strict=strict,
                                                             timeout=timeout)))
    ...
    def get_attribute(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.get_attribute(selector=selector,
                                                                name=name,
                                                                strict=strict,
                                                                timeout=timeout)))
    ...
    def hover(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.hover(selector=selector,
                                                        modifiers=mapping.to_impl(modifiers),
                                                        position=position,
                                                        timeout=timeout,
                                                        noWaitAfter=no_wait_after,
    ...
    def drag_and_drop(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.drag_and_drop(source=source,
                                                                target=target,
    ...
    def select_option(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.select_option(selector=selector,
    ...
    def input_value(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.input_value(selector=selector,
                                                              strict=strict,
                                                              timeout=timeout)))
    ...
    def set_input_files(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_input_files(selector=selector,
    ...
    def type(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.type(selector=selector,
                                                       text=text,
                                                       delay=delay,
                                                       strict=strict,
                                                       timeout=timeout,
    ...
    def press(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.press(selector=selector,
                                                        key=key,
                                                        delay=delay,
                                                        strict=strict,
                                                        timeout=timeout,
    ...
    def check(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.check(selector=selector,
                                                        position=position,
                                                        timeout=timeout,
                                                        force=force,
                                                        noWaitAfter=no_wait_after,
    ...
    def uncheck(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.uncheck(selector=selector,
                                                          position=position,
                                                          timeout=timeout,
                                                          force=force,
                                                          noWaitAfter=no_wait_after,
    ...
    def wait_for_timeout(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for_timeout(timeout=timeout)))
    ...
    def wait_for_function(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.wait_for_function(expression=expression,
                                                              arg=mapping.to_impl(arg),
                                                              timeout=timeout,
                                                              polling=polling)))
    ...
    def set_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_checked(selector=selector,
                                                              checked=checked,
                                                              position=position,
                                                              timeout=timeout,
                                                              force=force,
...
class Worker(SyncBase):
    ...
    def on(self, event: Literal['close'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
        Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
        terminated."""
        return super().on(event=event,f=f)
    def once(self, event: Literal['close'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
        Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
        terminated."""
        return super().once(event=event,f=f)
...
class Selectors(SyncBase):
    ...
    def register(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.register(name=name,
                                                           script=script,
                                                           path=path,
...
class Clock(SyncBase):
    ...
    def fast_forward(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.fast_forward(ticks=ticks)))
    ...
    def set_fixed_time(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_fixed_time(time=time)))
    ...
    def set_system_time(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_system_time(time=time)))
...
class Dialog(SyncBase):
    ...
    def accept(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.accept(promptText=prompt_text)))
...
class Page(SyncContextManager):
    ...
    @typing.overload
    def on(self, event: Literal['console'], f: typing.Callable[['ConsoleMessage'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['dialog'], f: typing.Callable[['Dialog'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['domcontentloaded'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the JavaScript
        [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched."""

    @typing.overload
    def on(self, event: Literal['download'], f: typing.Callable[['Download'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['filechooser'], f: typing.Callable[['FileChooser'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['frameattached'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
        Emitted when a frame is attached."""

    @typing.overload
    def on(self, event: Literal['framedetached'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
        Emitted when a frame is detached."""

    @typing.overload
    def on(self, event: Literal['framenavigated'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['pageerror'], f: typing.Callable[['Error'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['request'], f: typing.Callable[['Request'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['requestfailed'], f: typing.Callable[['Request'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['requestfinished'], f: typing.Callable[['Request'], 'None']) -> None:
        """
        Emitted when a request finishes successfully after downloading the response body. For a successful response, the
        sequence of events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def on(self, event: Literal['response'], f: typing.Callable[['Response'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['websocket'], f: typing.Callable[['WebSocket'], 'None']) -> None:
        """
        Emitted when `WebSocket` request is sent."""

    @typing.overload
    def on(self, event: Literal['worker'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
    ...
    def on(self, event: str, f: typing.Callable[...,None]) -> None:
        return super().on(event=event,f=f)
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the page closes."""

    @typing.overload
    def once(self, event: Literal['console'], f: typing.Callable[['ConsoleMessage'], 'None']) -> None:
        """
        Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
    ...
    @typing.overload
    def once(self, event: Literal['crash'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the page crashes. Browser pages might crash if they try to allocate too much memory. When the page
        crashes, ongoing and subsequent operations will throw.
    ...
    @typing.overload
    def once(self, event: Literal['dialog'], f: typing.Callable[['Dialog'], 'None']) -> None:
        """
        Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
        either `dialog.accept()` or `dialog.dismiss()` the dialog - otherwise the page will
        [freeze](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#never_blocking) waiting for the dialog,
    ...
    @typing.overload
    def once(self, event: Literal['domcontentloaded'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the JavaScript
        [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched."""

    @typing.overload
    def once(self, event: Literal['download'], f: typing.Callable[['Download'], 'None']) -> None:
        """
        Emitted when attachment download started. User can access basic file operations on downloaded content via the
        passed `Download` instance."""

    @typing.overload
    def once(self, event: Literal['filechooser'], f: typing.Callable[['FileChooser'], 'None']) -> None:
        """
        Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can
        respond to it via setting the input files using `file_chooser.set_files()` that can be uploaded after that.
    ...
    @typing.overload
    def once(self, event: Literal['frameattached'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
        Emitted when a frame is attached."""

    @typing.overload
    def once(self, event: Literal['framedetached'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
        Emitted when a frame is detached."""

    @typing.overload
    def once(self, event: Literal['framenavigated'], f: typing.Callable[['Frame'], 'None']) -> None:
        """
        Emitted when a frame is navigated to a new url."""

    @typing.overload
    def once(self, event: Literal['load'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched."""

    @typing.overload
    def once(self, event: Literal['pageerror'], f: typing.Callable[['Error'], 'None']) -> None:
        """
        Emitted when an uncaught exception happens within the page.
    ...
    @typing.overload
    def once(self, event: Literal['popup'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        Emitted when the page opens a new tab or window. This event is emitted in addition to the
        `browser_context.on('page')`, but only for popups relevant to this page.
    ...
    @typing.overload
    def once(self, event: Literal['request'], f: typing.Callable[['Request'], 'None']) -> None:
        """
        Emitted when a page issues a request. The [request] object is read-only. In order to intercept and mutate requests,
        see `page.route()` or `browser_context.route()`."""

    @typing.overload
    def once(self, event: Literal['requestfailed'], f: typing.Callable[['Request'], 'None']) -> None:
        """
        Emitted when a request fails, for example by timing out.
    ...
    @typing.overload
    def once(self, event: Literal['requestfinished'], f: typing.Callable[['Request'], 'None']) -> None:
        """
        Emitted when a request finishes successfully after downloading the response body. For a successful response, the
        sequence of events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def once(self, event: Literal['response'], f: typing.Callable[['Response'], 'None']) -> None:
        """
        Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
        events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def once(self, event: Literal['websocket'], f: typing.Callable[['WebSocket'], 'None']) -> None:
        """
        Emitted when `WebSocket` request is sent."""

    @typing.overload
    def once(self, event: Literal['worker'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
        Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned
        by the page."""
    ...
    def expose_function(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.expose_function(name=name,
    ...
    def expose_binding(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.expose_binding(name=name,
                                                                 callback=self._wrap_handler(callback),
                                                                 handle=handle)))
    ...
    def set_extra_http_headers(self,
        ...
        **NOTE** `page.set_extra_http_headers()` does not guarantee the order of headers in the outgoing requests.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers))))
    ...
    def reload(self,
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.reload(timeout=timeout,
                                                            waitUntil=wait_until)))
    ...
    def go_back(self,
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.go_back(timeout=timeout,
                                                             waitUntil=wait_until)))
    ...
    def go_forward(self,
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.go_forward(timeout=timeout,
                                                                waitUntil=wait_until)))
    ...
    def emulate_media(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.emulate_media(media=media,
    ...
    def set_viewport_size(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_viewport_size(viewportSize=viewport_size)))
    ...
    def add_init_script(self,
        ...
        **NOTE** The order of evaluation of multiple scripts installed via `browser_context.add_init_script()` and
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.add_init_script(script=script,
                                                                  path=path)))
    ...
    def route(self,
        ...
        **NOTE** Enabling routing disables http cache.
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.route(url=self._wrap_handler(url),
    ...
    def unroute(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.unroute(url=self._wrap_handler(url),
                                                          handler=self._wrap_handler(handler))))

    def route_web_socket(self,
                         url: typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]],
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.route_web_socket(url=self._wrap_handler(url),
                                                                   handler=self._wrap_handler(handler))))
    ...
    def unroute_all(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.unroute_all(behavior=behavior)))

    def route_from_har(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.route_from_har(har=har,
                                                                 url=url,
                                                                 notFound=not_found,
                                                                 update=update,
    ...
    def close(self,
        ...
        **NOTE** if `runBeforeUnload` is passed as true, a `beforeunload` dialog might be summoned and should be handled
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.close(runBeforeUnload=run_before_unload,
                                                        reason=reason)))
    ...
    def pdf(self,
        ...
        **NOTE** `headerTemplate` and `footerTemplate` markup have the following limitations: > 1. Script tags inside
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.pdf(scale=scale,
    ...
    def expect_console_message(self,
                               ...
                               *,
                               timeout: typing.Optional[float] = None) -> EventContextManager["ConsoleMessage"]:
    ...
    def expect_download(self,
                        ...
                        *,
                        timeout: typing.Optional[float] = None) -> EventContextManager["Download"]:
    ...
    def expect_file_chooser(self,
                            ...
                            *,
                            timeout: typing.Optional[float] = None) -> EventContextManager["FileChooser"]:
    ...
    def expect_popup(self,
                     ...
                     *,
                     timeout: typing.Optional[float] = None) -> EventContextManager["Page"]:
        """Page.expect_popup
    ...
    def expect_request(self,
                       ...
                       *,
                       timeout: typing.Optional[float] = None) -> EventContextManager["Request"]:
        """Page.expect_request
        ...
        **Usage**
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_request(urlOrPredicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)
    ...
    def expect_request_finished(self,
        ...
        EventContextManager[Request]
        """
        return EventContextManager(self, self._impl_obj.expect_request_finished(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)
    ...
    def expect_response(self,
        ...
        **Usage**
        ...
        EventContextManager[Response]
        """
        return EventContextManager(self, self._impl_obj.expect_response(urlOrPredicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_websocket(self,
                         predicate: typing.Optional[typing.Callable[["WebSocket"], bool]] = None,
                         *,
                         timeout: typing.Optional[float] = None) -> EventContextManager["WebSocket"]:
        ...
        """
        return EventContextManager(self, self._impl_obj.expect_websocket(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_worker(self,
                      predicate: typing.Optional[typing.Callable[["Worker"], bool]] = None,
                      *,
                      timeout: typing.Optional[float] = None) -> EventContextManager["Worker"]:
        """Page.expect_worker
    ...
    def add_locator_handler(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.add_locator_handler(locator=locator._impl_obj,
                                                                      handler=self._wrap_handler(handler),
                                                                      noWaitAfter=no_wait_after,
                                                                      times=times)))

    def remove_locator_handler(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.remove_locator_handler(locator=locator._impl_obj)))
...
class BrowserContext(SyncContextManager):
    ...
    @typing.overload
    def on(self, event: Literal['backgroundpage'], f: typing.Callable[['Page'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['close'], f: typing.Callable[['BrowserContext'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['weberror'], f: typing.Callable[['WebError'], 'None']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['serviceworker'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
    ...
    def on(self, event: str, f: typing.Callable[...,None]) -> None:
        return super().on(event=event,f=f)
    @typing.overload
    def once(self, event: Literal['backgroundpage'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        **NOTE** Only works with Chromium browser's persistent context.
    ...
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['BrowserContext'], 'None']) -> None:
        """
        Emitted when Browser context gets closed. This might happen because of one of the following:
        - Browser context is closed.
        - Browser application is closed or crashed.
    ...
    @typing.overload
    def once(self, event: Literal['page'], f: typing.Callable[['Page'], 'None']) -> None:
        """
        The event is emitted when a new Page is created in the BrowserContext. The page may still be loading. The event
        will also fire for popup pages. See also `page.on('popup')` to receive events about popups relevant to a
        specific page.
    ...
    @typing.overload
    def once(self, event: Literal['weberror'], f: typing.Callable[['WebError'], 'None']) -> None:
        """
        Emitted when exception is unhandled in any of the pages in this context. To listen for errors from a particular
        page, use `page.on('page_error')` instead."""
    ...
    @typing.overload
    def once(self, event: Literal['serviceworker'], f: typing.Callable[['Worker'], 'None']) -> None:
        """
        **NOTE** Service workers are only supported on Chromium-based browsers.
    ...
    def cookies(self,
        ...
        return mapping.from_impl_list(self._sync(self._impl_obj.cookies(urls=mapping.to_impl(urls))))
    ...
    def add_cookies(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.add_cookies(cookies=mapping.to_impl(cookies))))
    ...
    def clear_cookies(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.clear_cookies(name=name,
                                                                domain=domain,
                                                                path=path)))
    ...
    def grant_permissions(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.grant_permissions(permissions=mapping.to_impl(permissions),
                                                                    origin=origin)))
    ...
    def set_geolocation(self,
        ...
        **NOTE** Consider using `browser_context.grant_permissions()` to grant permissions for the browser context
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_geolocation(geolocation=geolocation)))
    ...
    def set_offline(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.set_offline(offline=offline)))
...
class CDPSession(SyncBase):
    ...
    def send(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.send(method=method,
...
class Browser(SyncContextManager):
    ...
    def on(self, event: Literal['disconnected'], f: typing.Callable[['Browser'], 'None']) -> None:
        """
        ...
        - The `browser.close()` method was called."""
        return super().on(event=event,f=f)
    def once(self, event: Literal['disconnected'], f: typing.Callable[['Browser'], 'None']) -> None:
        """
        Emitted when Browser gets disconnected from the browser application. This might happen because of one of the
        following:
        - Browser application is closed or crashed.
    ...
    def new_context(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.new_context(viewport=viewport,
                                                        screen=screen,
    ...
    def new_page(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.new_page(viewport=viewport,
                                                     screen=screen,
                                                     noViewport=no_viewport,
                                                     ignoreHTTPSErrors=ignore_https_errors,
                                                     javaScriptEnabled=java_script_enabled,
    ...
    def start_tracing(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.start_tracing(page=page._impl_obj if page else None,
                                                                path=path,
...
class BrowserType(SyncBase):
    ...
    def launch(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.launch(executablePath=executable_path,
                                                   channel=channel,
    ...
    def launch_persistent_context(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.launch_persistent_context(userDataDir=user_data_dir,
                                                                      channel=channel,
    ...
    def connect_over_cdp(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.connect_over_cdp(endpointURL=endpoint_url,
                                                             timeout=timeout,
                                                             slowMo=slow_mo,
                                                             headers=mapping.to_impl(headers))))
    ...
    def connect(self,
        ...
        **NOTE** The major and minor version of the Playwright instance that connects needs to match the version of
        ...
        return mapping.from_impl(self._sync(self._impl_obj.connect(wsEndpoint=ws_endpoint,
                                                    timeout=timeout,
                                                    slowMo=slow_mo,
                                                    headers=mapping.to_impl(headers),
...
class Tracing(SyncBase):
    ...
    def start(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.start(name=name,
                                                        title=title,
                                                        snapshots=snapshots,
                                                        screenshots=screenshots,
                                                        sources=sources)))
    ...
    def start_chunk(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.start_chunk(title=title,
                                                              name=name)))
    ...
    def group(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.group(name=name,
                                                        location=location)))
...
class Locator(SyncBase):
    ...
    def bounding_box(self,
        ...
        **Usage**
        ...
        return mapping.from_impl_nullable(self._sync(self._impl_obj.bounding_box(timeout=timeout)))
    ...
    def evaluate_all(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.evaluate_all(expression=expression,
                                                               arg=mapping.to_impl(arg))))
    ...
    def clear(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.clear(timeout=timeout,
                                                        noWaitAfter=no_wait_after,
                                                        force=force)))
    ...
    def element_handle(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.element_handle(timeout=timeout)))
    ...
    def focus(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.focus(timeout=timeout)))
    ...
    def drag_to(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.drag_to(target=target._impl_obj,
                                                          force=force,
                                                          noWaitAfter=no_wait_after,
                                                          timeout=timeout,
                                                          trial=trial,
    ...
    def inner_html(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.inner_html(timeout=timeout)))
    ...
    def inner_text(self,
        ...
        **NOTE** If you need to assert text on the page, prefer `locator_assertions.to_have_text()` with
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.inner_text(timeout=timeout)))
    ...
    def is_checked(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_checked(timeout=timeout)))
    ...
    def is_disabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_disabled(timeout=timeout)))
    ...
    def is_editable(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_editable(timeout=timeout)))
    ...
    def is_enabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_enabled(timeout=timeout)))
    ...
    def is_hidden(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_hidden(timeout=timeout)))
    ...
    def is_visible(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.is_visible(timeout=timeout)))
    ...
    def aria_snapshot(self,
        ...
        **Details**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.aria_snapshot(timeout=timeout,
                                                                ref=ref)))
    ...
    def text_content(self,
        ...
        **NOTE** If you need to assert text on the page, prefer `locator_assertions.to_have_text()` to avoid
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.text_content(timeout=timeout)))
    ...
    def press_sequentially(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.press_sequentially(text=text,
                                                                     delay=delay,
                                                                     timeout=timeout,
                                                                     noWaitAfter=no_wait_after)))
    ...
    def wait_for(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.wait_for(timeout=timeout,
                                                           state=state)))
...
class APIRequestContext(SyncBase):
    ...
    def dispose(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.dispose(reason=reason)))
    ...
    def delete(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.delete(url=url,
                                                   params=mapping.to_impl(params),
                                                   headers=mapping.to_impl(headers),
    ...
    def head(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.head(url=url,
                                                 params=mapping.to_impl(params),
                                                 headers=mapping.to_impl(headers),
                                                 data=mapping.to_impl(data),
                                                 form=mapping.to_impl(form),
    ...
    def get(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.get(url=url,
                                                params=mapping.to_impl(params),
                                                headers=mapping.to_impl(headers),
                                                data=mapping.to_impl(data),
                                                form=mapping.to_impl(form),
    ...
    def patch(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.patch(url=url,
                                                  params=mapping.to_impl(params),
                                                  headers=mapping.to_impl(headers),
                                                  data=mapping.to_impl(data),
                                                  form=mapping.to_impl(form),
    ...
    def put(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.put(url=url,
                                                params=mapping.to_impl(params),
                                                headers=mapping.to_impl(headers),
                                                data=mapping.to_impl(data),
                                                form=mapping.to_impl(form),
    ...
    def post(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.post(url=url,
                                                 params=mapping.to_impl(params),
                                                 headers=mapping.to_impl(headers),
                                                 data=mapping.to_impl(data),
                                                 form=mapping.to_impl(form),
    ...
    def fetch(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._sync(self._impl_obj.fetch(urlOrRequest=url_or_request,
                                                  params=mapping.to_impl(params),
                                                  method=method,
                                                  headers=mapping.to_impl(headers),
                                                  data=mapping.to_impl(data),
...
class APIRequest(SyncBase):
    ...
    def new_context(self,
        ...
        return mapping.from_impl(self._sync(self._impl_obj.new_context(baseURL=base_url,
                                                        extraHTTPHeaders=mapping.to_impl(extra_http_headers),
                                                        httpCredentials=http_credentials,
                                                        ignoreHTTPSErrors=ignore_https_errors,
                                                        proxy=proxy,
...
class PageAssertions(SyncBase):
    ...
    def to_have_title(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_title(titleOrRegExp=title_or_reg_exp,
                                                                timeout=timeout)))

    def not_to_have_title(self,
                          title_or_reg_exp: typing.Union[typing.Pattern[str], str],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_title(titleOrRegExp=title_or_reg_exp,
                                                                    timeout=timeout)))

    def to_have_url(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_url(urlOrRegExp=url_or_reg_exp,
                                                              timeout=timeout,
                                                              ignoreCase=ignore_case)))

    def not_to_have_url(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_url(urlOrRegExp=url_or_reg_exp,
                                                                  timeout=timeout,
                                                                  ignoreCase=ignore_case)))
...
class LocatorAssertions(SyncBase):
    ...
    def to_contain_text(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_contain_text(expected=mapping.to_impl(expected),
                                                                  useInnerText=use_inner_text,
                                                                  timeout=timeout,
                                                                  ignoreCase=ignore_case)))

    def not_to_contain_text(self,
                            expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                            *,
                            use_inner_text: typing.Optional[bool] = None,
                            timeout: typing.Optional[float] = None,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_contain_text(expected=mapping.to_impl(expected),
                                                                      useInnerText=use_inner_text,
                                                                      timeout=timeout,
                                                                      ignoreCase=ignore_case)))

    def to_have_attribute(self,
                          name: str,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_attribute(name=name,
                                                                    value=value,
                                                                    ignoreCase=ignore_case,
                                                                    timeout=timeout)))

    def not_to_have_attribute(self,
                              name: str,
                              value: typing.Union[str, typing.Pattern[str]],
                              *,
                              ignore_case: typing.Optional[bool] = None,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_attribute(name=name,
                                                                        value=value,
                                                                        ignoreCase=ignore_case,
                                                                        timeout=timeout)))

    def to_have_class(self,
                      expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_class(expected=mapping.to_impl(expected),
                                                                timeout=timeout)))

    def not_to_have_class(self,
                          expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_class(expected=mapping.to_impl(expected),
                                                                    timeout=timeout)))

    def to_contain_class(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_contain_class(expected=mapping.to_impl(expected),
                                                                   timeout=timeout)))

    def not_to_contain_class(self,
                             expected: typing.Union[typing.Sequence[str], str],
                             *,
                             timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_contain_class(expected=mapping.to_impl(expected),
                                                                       timeout=timeout)))

    def to_have_count(self,
                      count: int,
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_count(count=count,
                                                                timeout=timeout)))

    def not_to_have_count(self,
                          count: int,
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_count(count=count,
                                                                    timeout=timeout)))

    def to_have_css(self,
                    name: str,
                    value: typing.Union[str, typing.Pattern[str]],
                    *,
                    timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_css(name=name,
                                                              value=value,
                                                              timeout=timeout)))

    def not_to_have_css(self,
                        name: str,
                        value: typing.Union[str, typing.Pattern[str]],
                        *,
                        timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_css(name=name,
                                                                  value=value,
                                                                  timeout=timeout)))
    ...
    def to_have_id(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_id(id=id,
                                                             timeout=timeout)))

    def not_to_have_id(self,
                       id: typing.Union[str, typing.Pattern[str]],
                       *,
                       timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_id(id=id,
                                                                 timeout=timeout)))

    def to_have_js_property(self,
                            name: str,
                            value: typing.Any,
                            *,
                            timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_js_property(name=name,
                                                                      value=mapping.to_impl(value),
                                                                      timeout=timeout)))
    ...
    def not_to_have_js_property(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_js_property(name=name,
                                                                          value=mapping.to_impl(value),
                                                                          timeout=timeout)))

    def to_have_value(self,
                      value: typing.Union[str, typing.Pattern[str]],
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_value(value=value,
                                                                timeout=timeout)))

    def not_to_have_value(self,
                          value: typing.Union[str, typing.Pattern[str]],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_value(value=value,
                                                                    timeout=timeout)))

    def to_have_values(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_values(values=mapping.to_impl(values),
                                                                 timeout=timeout)))

    def not_to_have_values(self,
                           values: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]]],
                           *,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_values(values=mapping.to_impl(values),
                                                                     timeout=timeout)))

    def to_have_text(self,
                     expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                     *,
                     use_inner_text: typing.Optional[bool] = None,
                     timeout: typing.Optional[float] = None,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_text(expected=mapping.to_impl(expected),
                                                               useInnerText=use_inner_text,
                                                               timeout=timeout,
                                                               ignoreCase=ignore_case)))

    def not_to_have_text(self,
                         expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                         *,
                         use_inner_text: typing.Optional[bool] = None,
                         timeout: typing.Optional[float] = None,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_text(expected=mapping.to_impl(expected),
                                                                   useInnerText=use_inner_text,
                                                                   timeout=timeout,
                                                                   ignoreCase=ignore_case)))
    ...
    def to_be_attached(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_attached(attached=attached,
                                                                 timeout=timeout)))
    ...
    def to_be_checked(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_checked(timeout=timeout,
                                                                checked=checked,
                                                                indeterminate=indeterminate)))

    def not_to_be_attached(self,
                           *,
                           attached: typing.Optional[bool] = None,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_attached(attached=attached,
                                                                     timeout=timeout)))
    ...
    def not_to_be_checked(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_checked(timeout=timeout)))
    ...
    def to_be_disabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_disabled(timeout=timeout)))

    def not_to_be_disabled(self,
                           *,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_disabled(timeout=timeout)))
    ...
    def to_be_editable(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_editable(editable=editable,
                                                                 timeout=timeout)))
    ...
    def not_to_be_editable(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_editable(editable=editable,
                                                                     timeout=timeout)))
    ...
    def to_be_empty(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_empty(timeout=timeout)))
    ...
    def not_to_be_empty(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_empty(timeout=timeout)))
    ...
    def to_be_enabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_enabled(enabled=enabled,
                                                                timeout=timeout)))
    ...
    def not_to_be_enabled(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_enabled(enabled=enabled,
                                                                    timeout=timeout)))
    ...
    def to_be_hidden(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_hidden(timeout=timeout)))

    def not_to_be_hidden(self,
                         *,
                         timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_hidden(timeout=timeout)))
    ...
    def to_be_visible(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_visible(visible=visible,
                                                                timeout=timeout)))
    ...
    def not_to_be_visible(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_visible(visible=visible,
                                                                    timeout=timeout)))
    ...
    def to_be_focused(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_focused(timeout=timeout)))

    def not_to_be_focused(self,
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_focused(timeout=timeout)))
    ...
    def to_be_in_viewport(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_be_in_viewport(ratio=ratio,
                                                                    timeout=timeout)))

    def not_to_be_in_viewport(self,
                              *,
                              ratio: typing.Optional[float] = None,
                              timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_be_in_viewport(ratio=ratio,
                                                                        timeout=timeout)))

    def to_have_accessible_description(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_accessible_description(description=description,
                                                                                 ignoreCase=ignore_case,
                                                                                 timeout=timeout)))

    def not_to_have_accessible_description(self,
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_accessible_description(name=name,
                                                                                     ignoreCase=ignore_case,
                                                                                     timeout=timeout)))

    def to_have_accessible_name(self,
                                name: typing.Union[str, typing.Pattern[str]],
                                *,
                                ignore_case: typing.Optional[bool] = None,
                                timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_accessible_name(name=name,
                                                                          ignoreCase=ignore_case,
                                                                          timeout=timeout)))

    def not_to_have_accessible_name(self,
                                    name: typing.Union[str, typing.Pattern[str]],
                                    *,
                                    ignore_case: typing.Optional[bool] = None,
                                    timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_accessible_name(name=name,
                                                                              ignoreCase=ignore_case,
                                                                              timeout=timeout)))

    def to_have_role(self,
                     role: Literal['alert', 'alertdialog', 'application', 'article', 'banner', 'blockquote', 'button', 'caption', 'cell', 'checkbox', 'code', 'columnheader', 'combobox', 'complementary', 'contentinfo', 'definition', 'deletion', 'dialog', 'directory', 'document', 'emphasis', 'feed', 'figure', 'form', 'generic', 'grid', 'gridcell', 'group', 'heading', 'img', 'insertion', 'link', 'list', 'listbox', 'listitem', 'log', 'main', 'marquee', 'math', 'menu', 'menubar', 'menuitem', 'menuitemcheckbox', 'menuitemradio', 'meter', 'navigation', 'none', 'note', 'option', 'paragraph', 'presentation', 'progressbar', 'radio', 'radiogroup', 'region', 'row', 'rowgroup', 'rowheader', 'scrollbar', 'search', 'searchbox', 'separator', 'slider', 'spinbutton', 'status', 'strong', 'subscript', 'superscript', 'switch', 'tab', 'table', 'tablist', 'tabpanel', 'term', 'textbox', 'time', 'timer', 'toolbar', 'tooltip', 'tree', 'treegrid', 'treeitem'],
                     *,
                     timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_role(role=role,
                                                               timeout=timeout)))

    def to_have_accessible_error_message(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_have_accessible_error_message(errorMessage=error_message,
                                                                                   ignoreCase=ignore_case,
                                                                                   timeout=timeout)))

    def not_to_have_accessible_error_message(self,
                                             error_message: typing.Union[str, typing.Pattern[str]],
                                             *,
                                             ignore_case: typing.Optional[bool] = None,
                                             timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_accessible_error_message(errorMessage=error_message,
                                                                                       ignoreCase=ignore_case,
                                                                                       timeout=timeout)))

    def not_to_have_role(self,
                         role: Literal['alert', 'alertdialog', 'application', 'article', 'banner', 'blockquote', 'button', 'caption', 'cell', 'checkbox', 'code', 'columnheader', 'combobox', 'complementary', 'contentinfo', 'definition', 'deletion', 'dialog', 'directory', 'document', 'emphasis', 'feed', 'figure', 'form', 'generic', 'grid', 'gridcell', 'group', 'heading', 'img', 'insertion', 'link', 'list', 'listbox', 'listitem', 'log', 'main', 'marquee', 'math', 'menu', 'menubar', 'menuitem', 'menuitemcheckbox', 'menuitemradio', 'meter', 'navigation', 'none', 'note', 'option', 'paragraph', 'presentation', 'progressbar', 'radio', 'radiogroup', 'region', 'row', 'rowgroup', 'rowheader', 'scrollbar', 'search', 'searchbox', 'separator', 'slider', 'spinbutton', 'status', 'strong', 'subscript', 'superscript', 'switch', 'tab', 'table', 'tablist', 'tabpanel', 'term', 'textbox', 'time', 'timer', 'toolbar', 'tooltip', 'tree', 'treegrid', 'treeitem'],
                         *,
                         timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_have_role(role=role,
                                                                   timeout=timeout)))

    def to_match_aria_snapshot(self,
                               expected: str,
                               *,
                               timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.to_match_aria_snapshot(expected=expected,
                                                                         timeout=timeout)))

    def not_to_match_aria_snapshot(self,
                                   expected: str,
                                   *,
                                   timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(self._sync(self._impl_obj.not_to_match_aria_snapshot(expected=expected,
                                                                             timeout=timeout)))
