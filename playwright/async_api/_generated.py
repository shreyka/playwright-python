...
class Route(AsyncBase):
    ...
    async def abort(self,
              error_code: typing.Optional[str] = None) -> None:
        """Route.abort
    ...
    async def fulfill(self,
                *,
                ...
                response: typing.Optional["APIResponse"] = None) -> None:
        """Route.fulfill
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.fulfill(status=status,
    ...
    async def fetch(self,
              *,
              ...
              timeout: typing.Optional[float] = None) -> "APIResponse":
        """Route.fetch
        ...
        **Details**
        ...
        return mapping.from_impl(await self._impl_obj.fetch(url=url,
                                             method=method,
                                             headers=mapping.to_impl(headers),
    ...
    async def fallback(self,
                 *,
                 ...
                 method: typing.Optional[str] = None,
                 headers: typing.Optional[typing.Dict[str, str]] = None,
                 post_data: typing.Optional[typing.Union[typing.Any, str, bytes]] = None) -> None:
        """Route.fallback
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.fallback(url=url,
                                                      method=method,
                                                      headers=mapping.to_impl(headers),
                                                      postData=mapping.to_impl(post_data)))
    ...
    async def continue_(self,
        ...
        **NOTE** The `Cookie` header cannot be overridden using this method. If a value is provided, it will be ignored,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.continue_(url=url,
                                                       method=method,
                                                       headers=mapping.to_impl(headers),
                                                       postData=mapping.to_impl(post_data)))
...
class WebSocket(AsyncBase):
    ...
    @typing.overload
    def on(self, event: Literal['close'], f: typing.Callable[['WebSocket'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket closes."""

    @typing.overload
    def on(self, event: Literal['framereceived'], f: typing.Callable[['typing.Union[bytes, str]'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket receives a frame."""

    @typing.overload
    def on(self, event: Literal['framesent'], f: typing.Callable[['typing.Union[bytes, str]'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket sends a frame."""

    @typing.overload
    def on(self, event: Literal['socketerror'], f: typing.Callable[['str'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket has an error."""

    def on(self, event: str, f: typing.Callable[...,typing.Union[typing.Awaitable[None], None]]) -> None:
        return super().on(event=event,f=f)
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['WebSocket'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket closes."""

    @typing.overload
    def once(self, event: Literal['framereceived'], f: typing.Callable[['typing.Union[bytes, str]'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket receives a frame."""

    @typing.overload
    def once(self, event: Literal['framesent'], f: typing.Callable[['typing.Union[bytes, str]'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket sends a frame."""

    @typing.overload
    def once(self, event: Literal['socketerror'], f: typing.Callable[['str'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Fired when the websocket has an error."""

    def once(self, event: str, f: typing.Callable[...,typing.Union[typing.Awaitable[None], None]]) -> None:
    ...
    def expect_event(self,
                     ...
                     *,
                     timeout: typing.Optional[float] = None) -> AsyncEventContextManager:
    ...
    async def wait_for_event(self,
        ...
        **NOTE** In most cases, you should use `web_socket.expect_event()`.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for_event(event=event,
                                                            predicate=self._wrap_handler(predicate),
                                                            timeout=timeout))
...
class WebSocketRoute(AsyncBase):
    ...
    async def close(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.close(code=code,
                                                   reason=reason))
    ...
    def on_message(self,
                   handler: typing.Callable[[typing.Union[str, bytes]], typing.Any]) -> None:
        ...
        return mapping.from_maybe_impl(self._impl_obj.on_message(handler=self._wrap_handler(handler)))

    def on_close(self,
                 handler: typing.Callable[[typing.Optional[int], typing.Optional[str]], typing.Any]) -> None:
        ...
        return mapping.from_maybe_impl(self._impl_obj.on_close(handler=self._wrap_handler(handler)))
...
class Keyboard(AsyncBase):
    ...
    async def type(self,
             text: str,
             *,
             delay: typing.Optional[float] = None) -> None:
        """Keyboard.type
        ...
        **NOTE** For characters that are not on a US keyboard, only an `input` event will be sent.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.type(text=text,
                                                  delay=delay))
    ...
    async def press(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.press(key=key,
                                                   delay=delay))
...
class Mouse(AsyncBase):
    ...
    async def move(self,
             ...
             y: float,
             *,
             steps: typing.Optional[int] = None) -> None:
        """Mouse.move
        ...
        return mapping.from_maybe_impl(await self._impl_obj.move(x=x,
                                                  y=y,
                                                  steps=steps))
    ...
    async def down(self,
             *,
             ...
             click_count: typing.Optional[int] = None) -> None:
        """Mouse.down
        ...
        return mapping.from_maybe_impl(await self._impl_obj.down(button=button,
    ...
    async def up(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.up(button=button,
                                                clickCount=click_count))
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.click(x=x,
                                                   y=y,
                                                   delay=delay,
                                                   button=button,
                                                   clickCount=click_count))
    ...
    async def dblclick(self,
                 ...
                 *,
                 delay: typing.Optional[float] = None,
                 button: typing.Optional[Literal['left', 'middle', 'right']] = None) -> None:
        """Mouse.dblclick
        ...
        return mapping.from_maybe_impl(await self._impl_obj.dblclick(x=x,
                                                      y=y,
                                                      delay=delay,
                                                      button=button))
    ...
    async def wheel(self,
        ...
        **NOTE** Wheel events may cause scrolling if they are not handled, and this method does not wait for the scrolling
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wheel(deltaX=delta_x,
                                                   deltaY=delta_y))
...
class Touchscreen(AsyncBase):
    ...
    async def tap(self,
        ...
        **NOTE** `page.tap()` the method will throw if `hasTouch` option of the browser context is false.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.tap(x=x,
                                                 y=y))
...
class JSHandle(AsyncBase):
    ...
    async def evaluate(self,
                 expression: str,
                 arg: typing.Optional[typing.Any] = None) -> typing.Any:
        """JSHandle.evaluate
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.evaluate(expression=expression,
                                                      arg=mapping.to_impl(arg)))

    async def evaluate_handle(self,
                        expression: str,
                        arg: typing.Optional[typing.Any] = None) -> "JSHandle":
        ...
        return mapping.from_impl(await self._impl_obj.evaluate_handle(expression=expression,
                                                       arg=mapping.to_impl(arg)))
    ...
    async def get_property(self,
        ...
        return mapping.from_impl(await self._impl_obj.get_property(propertyName=property_name))
...
class ElementHandle(JSHandle):
    ...
    async def dispatch_event(self,
                       type: str,
                       event_init: typing.Optional[typing.Dict] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.dispatch_event(type=type,
    ...
    async def scroll_into_view_if_needed(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.scroll_into_view_if_needed(timeout=timeout))

    async def hover(self,
              *,
              modifiers: typing.Optional[typing.Sequence[Literal['Alt', 'Control', 'ControlOrMeta', 'Meta', 'Shift']]] = None,
              position: typing.Optional[Position] = None,
              timeout: typing.Optional[float] = None,
              no_wait_after: typing.Optional[bool] = None,
              force: typing.Optional[bool] = None,
              trial: typing.Optional[bool] = None) -> None:
        """ElementHandle.hover
        ...
        return mapping.from_maybe_impl(await self._impl_obj.hover(modifiers=mapping.to_impl(modifiers),
                                                   position=position,
                                                   timeout=timeout,
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.click(modifiers=mapping.to_impl(modifiers),
                                                   position=position,
                                                   delay=delay,
                                                   button=button,
                                                   clickCount=click_count,
    ...
    async def dblclick(self,
        ...
        **NOTE** `elementHandle.dblclick()` dispatches two `click` events and a single `dblclick` event.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.dblclick(modifiers=mapping.to_impl(modifiers),
                                                      position=position,
                                                      delay=delay,
                                                      button=button,
                                                      timeout=timeout,
    ...
    async def select_option(self,
                      ...
                      *,
                      ...
                      element: typing.Optional[typing.Union["ElementHandle", typing.Sequence["ElementHandle"]]] = None,
                      timeout: typing.Optional[float] = None,
                      force: typing.Optional[bool] = None,
                      no_wait_after: typing.Optional[bool] = None) -> typing.List[str]:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.select_option(value=mapping.to_impl(value),
    ...
    async def tap(self,
        ...
        **NOTE** `elementHandle.tap()` requires that the `hasTouch` option of the browser context be set to true.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.tap(modifiers=mapping.to_impl(modifiers),
                                                 position=position,
                                                 timeout=timeout,
                                                 force=force,
                                                 noWaitAfter=no_wait_after,
    ...
    async def fill(self,
             ...
             *,
             timeout: typing.Optional[float] = None,
             no_wait_after: typing.Optional[bool] = None,
             force: typing.Optional[bool] = None) -> None:
        """ElementHandle.fill
        ...
        return mapping.from_maybe_impl(await self._impl_obj.fill(value=value,
                                                  timeout=timeout,
                                                  noWaitAfter=no_wait_after,
                                                  force=force))
    ...
    async def select_text(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.select_text(force=force,
                                                         timeout=timeout))
    ...
    async def input_value(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.input_value(timeout=timeout))

    async def set_input_files(self,
                        files: typing.Union[str, pathlib.Path, FilePayload, typing.Sequence[typing.Union[str, pathlib.Path]], typing.Sequence[FilePayload]],
                        *,
                        timeout: typing.Optional[float] = None,
                        no_wait_after: typing.Optional[bool] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_input_files(files=mapping.to_impl(files),
                                                             timeout=timeout,
                                                             noWaitAfter=no_wait_after))
    ...
    async def set_checked(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_checked(checked=checked,
                                                         position=position,
                                                         timeout=timeout,
                                                         force=force,
                                                         noWaitAfter=no_wait_after,
    ...
    async def check(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.check(position=position,
                                                   timeout=timeout,
                                                   force=force,
                                                   noWaitAfter=no_wait_after,
                                                   trial=trial))
    ...
    async def uncheck(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.uncheck(position=position,
                                                     timeout=timeout,
                                                     force=force,
                                                     noWaitAfter=no_wait_after,
                                                     trial=trial))
    ...
    async def screenshot(self,
                   *,
                   ...
                   style: typing.Optional[str] = None) -> bytes:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.screenshot(timeout=timeout,
                                                        type=type,
                                                        path=path,
                                                        quality=quality,
    ...
    async def query_selector(self,
        ...
        return mapping.from_impl_nullable(await self._impl_obj.query_selector(selector=selector))
    ...
    async def query_selector_all(self,
        ...
        return mapping.from_impl_list(await self._impl_obj.query_selector_all(selector=selector))
    ...
    async def eval_on_selector(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.eval_on_selector(selector=selector,
    ...
    async def eval_on_selector_all(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.eval_on_selector_all(selector=selector,
                                                                  expression=expression,
                                                                  arg=mapping.to_impl(arg)))
    ...
    async def wait_for_element_state(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for_element_state(state=state,
                                                                    timeout=timeout))

    async def wait_for_selector(self,
                          selector: str,
                          *,
                          state: typing.Optional[Literal['attached', 'detached', 'hidden', 'visible']] = None,
                          timeout: typing.Optional[float] = None,
                          strict: typing.Optional[bool] = None) -> typing.Optional["ElementHandle"]:
        ...
        **NOTE** This method does not work across navigations, use `page.wait_for_selector()` instead.
        ...
        return mapping.from_impl_nullable(await self._impl_obj.wait_for_selector(selector=selector,
                                                                  state=state,
                                                                  timeout=timeout,
                                                                  strict=strict))
...
class Accessibility(AsyncBase):
    ...
    async def snapshot(self,
                 *,
                 ...
                 root: typing.Optional["ElementHandle"] = None) -> typing.Optional[typing.Dict]:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.snapshot(interestingOnly=interesting_only,
...
class FileChooser(AsyncBase):
    ...
    async def set_files(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_files(files=mapping.to_impl(files),
                                                       timeout=timeout,
                                                       noWaitAfter=no_wait_after))
...
class Frame(AsyncBase):
    ...
    async def goto(self,
             ...
             *,
             ...
             referer: typing.Optional[str] = None) -> typing.Optional["Response"]:
        """Frame.goto
        ...
        **NOTE** Headless mode doesn't support navigation to a PDF document. See the
        ...
        return mapping.from_impl_nullable(await self._impl_obj.goto(url=url,
                                                     timeout=timeout,
    ...
    def expect_navigation(self,
                          *,
                          url: typing.Optional[typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]]] = None,
                          wait_until: typing.Optional[Literal['commit', 'domcontentloaded', 'load', 'networkidle']] = None,
                          timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Response"]:
    ...
    async def wait_for_url(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for_url(url=self._wrap_handler(url),
                                                          waitUntil=wait_until,
                                                          timeout=timeout))

    async def wait_for_load_state(self,
                            state: typing.Optional[Literal['domcontentloaded', 'load', 'networkidle']] = None,
                            *,
                            timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for_load_state(state=state,
                                                                 timeout=timeout))
    ...
    async def wait_for_selector(self,
                          ...
                          *,
                          ...
                          timeout: typing.Optional[float] = None,
                          state: typing.Optional[Literal['attached', 'detached', 'hidden', 'visible']] = None) -> typing.Optional["ElementHandle"]:
    ...
    async def is_checked(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_checked(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout))
    ...
    async def is_disabled(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_disabled(selector=selector,
                                                         strict=strict,
                                                         timeout=timeout))
    ...
    async def is_editable(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_editable(selector=selector,
                                                         strict=strict,
                                                         timeout=timeout))
    ...
    async def is_enabled(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_enabled(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout))
    ...
    async def is_hidden(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_hidden(selector=selector,
                                                       strict=strict,
                                                       timeout=timeout))
    ...
    async def is_visible(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_visible(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout))
    ...
    async def dispatch_event(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.dispatch_event(selector=selector,
                                                            type=type,
                                                            eventInit=mapping.to_impl(event_init),
                                                            strict=strict,
                                                            timeout=timeout))
    ...
    async def eval_on_selector(self,
                         ...
                         *,
                         strict: typing.Optional[bool] = None) -> typing.Any:
    ...
    async def set_content(self,
                    ...
                    *,
                    timeout: typing.Optional[float] = None,
                    wait_until: typing.Optional[Literal['commit', 'domcontentloaded', 'load', 'networkidle']] = None) -> None:
        """Frame.set_content
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_content(html=html,
                                                         timeout=timeout,
                                                         waitUntil=wait_until))
    ...
    async def add_script_tag(self,
                       *,
                       ...
                       type: typing.Optional[str] = None) -> "ElementHandle":
        ...
        return mapping.from_impl(await self._impl_obj.add_script_tag(url=url,
                                                      path=path,
                                                      content=content,
                                                      type=type))
    ...
    async def add_style_tag(self,
                      *,
                      url: typing.Optional[str] = None,
                      path: typing.Optional[typing.Union[str, pathlib.Path]] = None,
                      content: typing.Optional[str] = None) -> "ElementHandle":
        """Frame.add_style_tag
        ...
        return mapping.from_impl(await self._impl_obj.add_style_tag(url=url,
                                                     path=path,
                                                     content=content))
    ...
    async def click(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.click(selector=selector,
    ...
    async def dblclick(self,
        ...
        **NOTE** `frame.dblclick()` dispatches two `click` events and a single `dblclick` event.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.dblclick(selector=selector,
                                                      modifiers=mapping.to_impl(modifiers),
                                                      position=position,
                                                      delay=delay,
                                                      button=button,
    ...
    async def tap(self,
        ...
        **NOTE** `frame.tap()` requires that the `hasTouch` option of the browser context be set to true.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.tap(selector=selector,
                                                 modifiers=mapping.to_impl(modifiers),
                                                 position=position,
                                                 timeout=timeout,
                                                 force=force,
    ...
    async def fill(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.fill(selector=selector,
                                                  value=value,
                                                  timeout=timeout,
                                                  noWaitAfter=no_wait_after,
                                                  strict=strict,
    ...
    def locator(self,
                ...
                *,
                ...
                has_not: typing.Optional["Locator"] = None) -> "Locator":
        """Frame.locator
    ...
    def get_by_alt_text(self,
                        text: typing.Union[str, typing.Pattern[str]],
                        *,
                        exact: typing.Optional[bool] = None) -> "Locator":
        ...
        **Usage**
        ...
        return mapping.from_impl(self._impl_obj.get_by_alt_text(text=text,
                                                 exact=exact))
    ...
    def get_by_label(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._impl_obj.get_by_label(text=text,
                                              exact=exact))
    ...
    def get_by_placeholder(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._impl_obj.get_by_placeholder(text=text,
                                                    exact=exact))
    ...
    def get_by_role(self,
        ...
        **Details**
        ...
        return mapping.from_impl(self._impl_obj.get_by_role(role=role,
                                             checked=checked,
                                             disabled=disabled,
                                             expanded=expanded,
    ...
    def get_by_test_id(self,
                       test_id: typing.Union[str, typing.Pattern[str]]) -> "Locator":
    ...
    def get_by_text(self,
        ...
        **Details**
        ...
        return mapping.from_impl(self._impl_obj.get_by_text(text=text,
                                             exact=exact))
    ...
    def get_by_title(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(self._impl_obj.get_by_title(text=text,
                                              exact=exact))

    def frame_locator(self,
                      selector: str) -> "FrameLocator":
        """Frame.frame_locator
    ...
    async def focus(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.focus(selector=selector,
                                                   strict=strict,
                                                   timeout=timeout))
    ...
    async def text_content(self,
                     ...
                     *,
                     strict: typing.Optional[bool] = None,
                     timeout: typing.Optional[float] = None) -> typing.Optional[str]:
        """Frame.text_content
        ...
        return mapping.from_maybe_impl(await self._impl_obj.text_content(selector=selector,
                                                          strict=strict,
                                                          timeout=timeout))
    ...
    async def inner_text(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.inner_text(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout))
    ...
    async def inner_html(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.inner_html(selector=selector,
                                                        strict=strict,
                                                        timeout=timeout))
    ...
    async def get_attribute(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.get_attribute(selector=selector,
                                                           name=name,
                                                           strict=strict,
                                                           timeout=timeout))
    ...
    async def hover(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.hover(selector=selector,
                                                   modifiers=mapping.to_impl(modifiers),
                                                   position=position,
                                                   timeout=timeout,
                                                   noWaitAfter=no_wait_after,
    ...
    async def drag_and_drop(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.drag_and_drop(source=source,
                                                           target=target,
    ...
    async def select_option(self,
                      ...
                      *,
                      ...
                      no_wait_after: typing.Optional[bool] = None,
                      strict: typing.Optional[bool] = None,
                      force: typing.Optional[bool] = None) -> typing.List[str]:
        """Frame.select_option
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.select_option(selector=selector,
    ...
    async def input_value(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.input_value(selector=selector,
                                                         strict=strict,
                                                         timeout=timeout))
    ...
    async def set_input_files(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_input_files(selector=selector,
    ...
    async def type(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.type(selector=selector,
                                                  text=text,
                                                  delay=delay,
                                                  strict=strict,
                                                  timeout=timeout,
    ...
    async def press(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.press(selector=selector,
                                                   key=key,
                                                   delay=delay,
                                                   strict=strict,
                                                   timeout=timeout,
    ...
    async def check(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.check(selector=selector,
                                                   position=position,
                                                   timeout=timeout,
                                                   force=force,
                                                   noWaitAfter=no_wait_after,
    ...
    async def uncheck(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.uncheck(selector=selector,
                                                     position=position,
                                                     timeout=timeout,
                                                     force=force,
                                                     noWaitAfter=no_wait_after,
    ...
    async def wait_for_timeout(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for_timeout(timeout=timeout))
    ...
    async def wait_for_function(self,
                          ...
                          *,
                          arg: typing.Optional[typing.Any] = None,
                          timeout: typing.Optional[float] = None,
                          polling: typing.Optional[typing.Union[float, Literal['raf']]] = None) -> "JSHandle":
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.wait_for_function(expression=expression,
                                                         arg=mapping.to_impl(arg),
                                                         timeout=timeout,
                                                         polling=polling))
    ...
    async def set_checked(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_checked(selector=selector,
                                                         checked=checked,
                                                         position=position,
                                                         timeout=timeout,
                                                         force=force,
...
class FrameLocator(AsyncBase):
    ...
    def locator(self,
        ...
        return mapping.from_impl(self._impl_obj.locator(selectorOrLocator=selector_or_locator,
                                         hasText=has_text,
                                         hasNotText=has_not_text,
                                         has=has._impl_obj if has else None,
                                         hasNot=has_not._impl_obj if has_not else None))
...
class Worker(AsyncBase):
    ...
    def on(self, event: Literal['close'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
        terminated."""
        return super().on(event=event,f=f)
    def once(self, event: Literal['close'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when this dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is
        terminated."""
        return super().once(event=event,f=f)
...
class Selectors(AsyncBase):
    ...
    async def register(self,
                 ...
                 *,
                 path: typing.Optional[typing.Union[str, pathlib.Path]] = None,
                 content_script: typing.Optional[bool] = None) -> None:
        """Selectors.register
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.register(name=name,
                                                      script=script,
                                                      path=path,
                                                      contentScript=content_script))

    def set_test_id_attribute(self,
        ...
        return mapping.from_maybe_impl(self._impl_obj.set_test_id_attribute(attributeName=attribute_name))
...
class Clock(AsyncBase):
    ...
    async def install(self,
                *,
                time: typing.Optional[typing.Union[float, str, datetime.datetime]] = None) -> None:
        """Clock.install
    ...
    async def fast_forward(self,
                     ticks: typing.Union[int, str]) -> None:
        """Clock.fast_forward
    ...
    async def pause_at(self,
                 time: typing.Union[float, str, datetime.datetime]) -> None:
        """Clock.pause_at
    ...
    async def set_system_time(self,
                        time: typing.Union[float, str, datetime.datetime]) -> None:
...
class Dialog(AsyncBase):
    ...
    async def accept(self,
               prompt_text: typing.Optional[str] = None) -> None:
        """Dialog.accept
        ...
        return mapping.from_maybe_impl(await self._impl_obj.accept(promptText=prompt_text))
...
class Page(AsyncContextManager):
    ...
    @typing.overload
    def on(self, event: Literal['close'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the page closes."""

    @typing.overload
    def on(self, event: Literal['console'], f: typing.Callable[['ConsoleMessage'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['crash'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['dialog'], f: typing.Callable[['Dialog'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['domcontentloaded'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the JavaScript
        [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched."""

    @typing.overload
    def on(self, event: Literal['download'], f: typing.Callable[['Download'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['filechooser'], f: typing.Callable[['FileChooser'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['frameattached'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is attached."""

    @typing.overload
    def on(self, event: Literal['framedetached'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is detached."""

    @typing.overload
    def on(self, event: Literal['framenavigated'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is navigated to a new url."""

    @typing.overload
    def on(self, event: Literal['load'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched."""

    @typing.overload
    def on(self, event: Literal['pageerror'], f: typing.Callable[['Error'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['popup'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['request'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['requestfailed'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['requestfinished'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a request finishes successfully after downloading the response body. For a successful response, the
        sequence of events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def on(self, event: Literal['response'], f: typing.Callable[['Response'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['websocket'], f: typing.Callable[['WebSocket'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when `WebSocket` request is sent."""

    @typing.overload
    def on(self, event: Literal['worker'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    def on(self, event: str, f: typing.Callable[...,typing.Union[typing.Awaitable[None], None]]) -> None:
        return super().on(event=event,f=f)
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the page closes."""

    @typing.overload
    def once(self, event: Literal['console'], f: typing.Callable[['ConsoleMessage'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when JavaScript within the page calls one of console API methods, e.g. `console.log` or `console.dir`.
    ...
    @typing.overload
    def once(self, event: Literal['crash'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the page crashes. Browser pages might crash if they try to allocate too much memory. When the page
        crashes, ongoing and subsequent operations will throw.
    ...
    @typing.overload
    def once(self, event: Literal['dialog'], f: typing.Callable[['Dialog'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Listener **must**
        either `dialog.accept()` or `dialog.dismiss()` the dialog - otherwise the page will
        [freeze](https://developer.mozilla.org/en-US/docs/Web/JavaScript/EventLoop#never_blocking) waiting for the dialog,
    ...
    @typing.overload
    def once(self, event: Literal['domcontentloaded'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the JavaScript
        [`DOMContentLoaded`](https://developer.mozilla.org/en-US/docs/Web/Events/DOMContentLoaded) event is dispatched."""

    @typing.overload
    def once(self, event: Literal['download'], f: typing.Callable[['Download'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when attachment download started. User can access basic file operations on downloaded content via the
        passed `Download` instance."""

    @typing.overload
    def once(self, event: Literal['filechooser'], f: typing.Callable[['FileChooser'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can
        respond to it via setting the input files using `file_chooser.set_files()` that can be uploaded after that.
    ...
    @typing.overload
    def once(self, event: Literal['frameattached'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is attached."""

    @typing.overload
    def once(self, event: Literal['framedetached'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is detached."""

    @typing.overload
    def once(self, event: Literal['framenavigated'], f: typing.Callable[['Frame'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a frame is navigated to a new url."""

    @typing.overload
    def once(self, event: Literal['load'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the JavaScript [`load`](https://developer.mozilla.org/en-US/docs/Web/Events/load) event is dispatched."""

    @typing.overload
    def once(self, event: Literal['pageerror'], f: typing.Callable[['Error'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when an uncaught exception happens within the page.
    ...
    @typing.overload
    def once(self, event: Literal['popup'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when the page opens a new tab or window. This event is emitted in addition to the
        `browser_context.on('page')`, but only for popups relevant to this page.
    ...
    @typing.overload
    def once(self, event: Literal['request'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a page issues a request. The [request] object is read-only. In order to intercept and mutate requests,
        see `page.route()` or `browser_context.route()`."""

    @typing.overload
    def once(self, event: Literal['requestfailed'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a request fails, for example by timing out.
    ...
    @typing.overload
    def once(self, event: Literal['requestfinished'], f: typing.Callable[['Request'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a request finishes successfully after downloading the response body. For a successful response, the
        sequence of events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def once(self, event: Literal['response'], f: typing.Callable[['Response'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when [response] status and headers are received for a request. For a successful response, the sequence of
        events is `request`, `response` and `requestfinished`."""

    @typing.overload
    def once(self, event: Literal['websocket'], f: typing.Callable[['WebSocket'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when `WebSocket` request is sent."""

    @typing.overload
    def once(self, event: Literal['worker'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when a dedicated [WebWorker](https://developer.mozilla.org/en-US/docs/Web/API/Web_Workers_API) is spawned
        by the page."""
    ...
    def frame(self,
              ...
              *,
              url: typing.Optional[typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]]] = None) -> typing.Optional["Frame"]:
        """Page.frame
    ...
    async def dispatch_event(self,
                       ...
                       *,
                       timeout: typing.Optional[float] = None,
                       strict: typing.Optional[bool] = None) -> None:
        """Page.dispatch_event
    ...
    async def expose_function(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.expose_function(name=name,
    ...
    async def expose_binding(self,
                       ...
                       *,
                       handle: typing.Optional[bool] = None) -> None:
        """Page.expose_binding
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.expose_binding(name=name,
                                                            callback=self._wrap_handler(callback),
                                                            handle=handle))
    ...
    async def set_extra_http_headers(self,
        ...
        **NOTE** `page.set_extra_http_headers()` does not guarantee the order of headers in the outgoing requests.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_extra_http_headers(headers=mapping.to_impl(headers)))
    ...
    async def reload(self,
               *,
               timeout: typing.Optional[float] = None,
               wait_until: typing.Optional[Literal['commit', 'domcontentloaded', 'load', 'networkidle']] = None) -> typing.Optional["Response"]:
        """Page.reload
        ...
        return mapping.from_impl_nullable(await self._impl_obj.reload(timeout=timeout,
                                                       waitUntil=wait_until))
    ...
    async def go_back(self,
        ...
        return mapping.from_impl_nullable(await self._impl_obj.go_back(timeout=timeout,
                                                        waitUntil=wait_until))
    ...
    async def go_forward(self,
        ...
        return mapping.from_impl_nullable(await self._impl_obj.go_forward(timeout=timeout,
                                                           waitUntil=wait_until))
    ...
    async def emulate_media(self,
                      *,
                      ...
                      color_scheme: typing.Optional[Literal['dark', 'light', 'no-preference', 'null']] = None,
                      reduced_motion: typing.Optional[Literal['no-preference', 'null', 'reduce']] = None,
                      forced_colors: typing.Optional[Literal['active', 'none', 'null']] = None,
                      contrast: typing.Optional[Literal['more', 'no-preference', 'null']] = None) -> None:
        """Page.emulate_media
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.emulate_media(media=media,
    ...
    async def set_viewport_size(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_viewport_size(viewportSize=viewport_size))
    ...
    async def add_init_script(self,
                        script: typing.Optional[str] = None,
                        *,
                        path: typing.Optional[typing.Union[str, pathlib.Path]] = None) -> None:
        ...
        **NOTE** The order of evaluation of multiple scripts installed via `browser_context.add_init_script()` and
        ...
        return mapping.from_maybe_impl(await self._impl_obj.add_init_script(script=script,
                                                             path=path))

    async def route(self,
              url: typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]],
              handler: typing.Union[typing.Callable[["Route"], typing.Any], typing.Callable[["Route", "Request"], typing.Any]],
              *,
              times: typing.Optional[int] = None) -> None:
        """Page.route
        ...
        **NOTE** Enabling routing disables http cache.
        ...
        return mapping.from_maybe_impl(await self._impl_obj.route(url=self._wrap_handler(url),
                                                   handler=self._wrap_handler(handler),
                                                   times=times))

    async def unroute(self,
                url: typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]],
                handler: typing.Optional[typing.Union[typing.Callable[["Route"], typing.Any], typing.Callable[["Route", "Request"], typing.Any]]] = None) -> None:
        """Page.unroute
        ...
        return mapping.from_maybe_impl(await self._impl_obj.unroute(url=self._wrap_handler(url),
                                                     handler=self._wrap_handler(handler)))

    async def route_web_socket(self,
                         url: typing.Union[str, typing.Pattern[str], typing.Callable[[str], bool]],
                         handler: typing.Callable[["WebSocketRoute"], typing.Any]) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.route_web_socket(url=self._wrap_handler(url),
                                                              handler=self._wrap_handler(handler)))

    async def unroute_all(self,
                    *,
                    behavior: typing.Optional[Literal['default', 'ignoreErrors', 'wait']] = None) -> None:
        """Page.unroute_all
        ...
        return mapping.from_maybe_impl(await self._impl_obj.unroute_all(behavior=behavior))

    async def route_from_har(self,
                       ...
                       *,
                       ...
                       update_mode: typing.Optional[Literal['full', 'minimal']] = None) -> None:
        """Page.route_from_har
        ...
        return mapping.from_maybe_impl(await self._impl_obj.route_from_har(har=har,
                                                            url=url,
                                                            notFound=not_found,
                                                            update=update,
    ...
    async def close(self,
        ...
        **NOTE** if `runBeforeUnload` is passed as true, a `beforeunload` dialog might be summoned and should be handled
        ...
        return mapping.from_maybe_impl(await self._impl_obj.close(runBeforeUnload=run_before_unload,
                                                   reason=reason))
    ...
    async def select_option(self,
                      ...
                      *,
                      ...
                      no_wait_after: typing.Optional[bool] = None,
                      force: typing.Optional[bool] = None,
                      strict: typing.Optional[bool] = None) -> typing.List[str]:
        """Page.select_option
    ...
    async def pdf(self,
            *,
            ...
            tagged: typing.Optional[bool] = None) -> bytes:
        """Page.pdf
        ...
        **NOTE** `headerTemplate` and `footerTemplate` markup have the following limitations: > 1. Script tags inside
        ...
        return mapping.from_maybe_impl(await self._impl_obj.pdf(scale=scale,
    ...
    def expect_console_message(self,
                               ...
                               *,
                               timeout: typing.Optional[float] = None) -> AsyncEventContextManager["ConsoleMessage"]:
    ...
    def expect_download(self,
                        ...
                        *,
                        timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Download"]:
    ...
    def expect_file_chooser(self,
                            ...
                            *,
                            timeout: typing.Optional[float] = None) -> AsyncEventContextManager["FileChooser"]:
    ...
    def expect_popup(self,
                     ...
                     *,
                     timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Page"]:
        """Page.expect_popup
    ...
    def expect_request(self,
                       ...
                       *,
                       timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Request"]:
        """Page.expect_request
        ...
        **Usage**
        ...
        return AsyncEventContextManager(self._impl_obj.expect_request(urlOrPredicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_request_finished(self,
        ...
        return AsyncEventContextManager(self._impl_obj.expect_request_finished(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_response(self,
                        url_or_predicate: typing.Union[str, typing.Pattern[str], typing.Callable[["Response"], bool]],
                        *,
                        timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Response"]:
        ...
        **Usage**
        ...
        return AsyncEventContextManager(self._impl_obj.expect_response(urlOrPredicate=self._wrap_handler(url_or_predicate),
            timeout=timeout).future)

    def expect_websocket(self,
                         predicate: typing.Optional[typing.Callable[["WebSocket"], bool]] = None,
                         *,
                         timeout: typing.Optional[float] = None) -> AsyncEventContextManager["WebSocket"]:
        ...
        return AsyncEventContextManager(self._impl_obj.expect_websocket(predicate=self._wrap_handler(predicate),
            timeout=timeout).future)

    def expect_worker(self,
                      predicate: typing.Optional[typing.Callable[["Worker"], bool]] = None,
                      *,
                      timeout: typing.Optional[float] = None) -> AsyncEventContextManager["Worker"]:
        """Page.expect_worker
    ...
    async def add_locator_handler(self,
                            locator: "Locator",
                            handler: typing.Union[typing.Callable[["Locator"], typing.Any], typing.Callable[[], typing.Any]],
                            *,
                            no_wait_after: typing.Optional[bool] = None,
                            times: typing.Optional[int] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.add_locator_handler(locator=locator._impl_obj,
                                                                 handler=self._wrap_handler(handler),
                                                                 noWaitAfter=no_wait_after,
                                                                 times=times))

    async def remove_locator_handler(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.remove_locator_handler(locator=locator._impl_obj))
...
class BrowserContext(AsyncContextManager):
    ...
    @typing.overload
    def on(self, event: Literal['backgroundpage'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['close'], f: typing.Callable[['BrowserContext'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['page'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['weberror'], f: typing.Callable[['WebError'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    @typing.overload
    def on(self, event: Literal['serviceworker'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
    ...
    def on(self, event: str, f: typing.Callable[...,typing.Union[typing.Awaitable[None], None]]) -> None:
        return super().on(event=event,f=f)
    @typing.overload
    def once(self, event: Literal['backgroundpage'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        **NOTE** Only works with Chromium browser's persistent context.
    ...
    @typing.overload
    def once(self, event: Literal['close'], f: typing.Callable[['BrowserContext'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when Browser context gets closed. This might happen because of one of the following:
        - Browser context is closed.
        - Browser application is closed or crashed.
    ...
    @typing.overload
    def once(self, event: Literal['page'], f: typing.Callable[['Page'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        The event is emitted when a new Page is created in the BrowserContext. The page may still be loading. The event
        will also fire for popup pages. See also `page.on('popup')` to receive events about popups relevant to a
        specific page.
    ...
    @typing.overload
    def once(self, event: Literal['weberror'], f: typing.Callable[['WebError'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when exception is unhandled in any of the pages in this context. To listen for errors from a particular
        page, use `page.on('page_error')` instead."""
    ...
    @typing.overload
    def once(self, event: Literal['serviceworker'], f: typing.Callable[['Worker'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        **NOTE** Service workers are only supported on Chromium-based browsers.
    ...
    async def cookies(self,
                urls: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None) -> typing.List[Cookie]:
        ...
        return mapping.from_impl_list(await self._impl_obj.cookies(urls=mapping.to_impl(urls)))

    async def add_cookies(self,
                    cookies: typing.Sequence[SetCookieParam]) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.add_cookies(cookies=mapping.to_impl(cookies)))

    async def clear_cookies(self,
                      *,
                      name: typing.Optional[typing.Union[str, typing.Pattern[str]]] = None,
                      domain: typing.Optional[typing.Union[str, typing.Pattern[str]]] = None,
                      path: typing.Optional[typing.Union[str, typing.Pattern[str]]] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.clear_cookies(name=name,
                                                           domain=domain,
                                                           path=path))
    ...
    async def grant_permissions(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.grant_permissions(permissions=mapping.to_impl(permissions),
                                                               origin=origin))
    ...
    async def set_geolocation(self,
                        geolocation: typing.Optional[Geolocation] = None) -> None:
        ...
        **NOTE** Consider using `browser_context.grant_permissions()` to grant permissions for the browser context
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_geolocation(geolocation=geolocation))
    ...
    async def set_offline(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.set_offline(offline=offline))
    ...
    async def storage_state(self,
                      *,
                      path: typing.Optional[typing.Union[str, pathlib.Path]] = None,
                      indexed_db: typing.Optional[bool] = None) -> StorageState:
    ...
    async def new_cdp_session(self,
                        page: typing.Union["Page", "Frame"]) -> "CDPSession":
...
class CDPSession(AsyncBase):
    ...
    async def send(self,
             method: str,
             params: typing.Optional[typing.Dict] = None) -> typing.Dict:
        """CDPSession.send
        ...
        return mapping.from_maybe_impl(await self._impl_obj.send(method=method,
...
class Browser(AsyncContextManager):
    ...
    def on(self, event: Literal['disconnected'], f: typing.Callable[['Browser'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        ...
        - The `browser.close()` method was called."""
        return super().on(event=event,f=f)
    def once(self, event: Literal['disconnected'], f: typing.Callable[['Browser'], 'typing.Union[typing.Awaitable[None], None]']) -> None:
        """
        Emitted when Browser gets disconnected from the browser application. This might happen because of one of the
        following:
        - Browser application is closed or crashed.
    ...
    async def new_context(self,
                    *,
                    ...
                    client_certificates: typing.Optional[typing.List[ClientCertificate]] = None) -> "BrowserContext":
        """Browser.new_context
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.new_context(viewport=viewport,
                                                   screen=screen,
    ...
    async def new_page(self,
                 *,
                 ...
                 record_har_mode: typing.Optional[Literal['full', 'minimal']] = None,
                 record_har_content: typing.Optional[Literal['attach', 'embed', 'omit']] = None,
                 client_certificates: typing.Optional[typing.List[ClientCertificate]] = None) -> "Page":
        """Browser.new_page
        ...
        return mapping.from_impl(await self._impl_obj.new_page(viewport=viewport,
                                                screen=screen,
                                                noViewport=no_viewport,
                                                ignoreHTTPSErrors=ignore_https_errors,
                                                javaScriptEnabled=java_script_enabled,
    ...
    async def start_tracing(self,
                      *,
                      ...
                      categories: typing.Optional[typing.Sequence[str]] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.start_tracing(page=page._impl_obj if page else None,
                                                           path=path,
...
class BrowserType(AsyncBase):
    ...
    async def launch(self,
               *,
               ...
               ignore_default_args: typing.Optional[typing.Union[bool, typing.Sequence[str]]] = None,
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.launch(executablePath=executable_path,
                                              channel=channel,
    ...
    async def launch_persistent_context(self,
        ...
        return mapping.from_impl(await self._impl_obj.launch_persistent_context(userDataDir=user_data_dir,
                                                                 channel=channel,
    ...
    async def connect_over_cdp(self,
                         endpoint_url: str,
                         *,
                         timeout: typing.Optional[float] = None,
                         slow_mo: typing.Optional[float] = None,
                         headers: typing.Optional[typing.Dict[str, str]] = None) -> "Browser":
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.connect_over_cdp(endpointURL=endpoint_url,
                                                        timeout=timeout,
                                                        slowMo=slow_mo,
                                                        headers=mapping.to_impl(headers)))
    ...
    async def connect(self,
                ...
                *,
                ...
                slow_mo: typing.Optional[float] = None,
                headers: typing.Optional[typing.Dict[str, str]] = None,
                expose_network: typing.Optional[str] = None) -> "Browser":
        """BrowserType.connect
        ...
        **NOTE** The major and minor version of the Playwright instance that connects needs to match the version of
        ...
        return mapping.from_impl(await self._impl_obj.connect(wsEndpoint=ws_endpoint,
                                               timeout=timeout,
                                               slowMo=slow_mo,
                                               headers=mapping.to_impl(headers),
...
class Tracing(AsyncBase):
    ...
    async def start(self,
              *,
              ...
              screenshots: typing.Optional[bool] = None,
              sources: typing.Optional[bool] = None) -> None:
        """Tracing.start
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.start(name=name,
                                                   title=title,
                                                   snapshots=snapshots,
                                                   screenshots=screenshots,
                                                   sources=sources))
    ...
    async def group(self,
              name: str,
              *,
              location: typing.Optional[TracingGroupLocation] = None) -> None:
        """Tracing.group
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.group(name=name,
                                                   location=location))
...
class Locator(AsyncBase):
    ...
    async def bounding_box(self,
                     *,
                     timeout: typing.Optional[float] = None) -> typing.Optional[FloatRect]:
        ...
        **Usage**
        ...
        return mapping.from_impl_nullable(await self._impl_obj.bounding_box(timeout=timeout))
    ...
    async def evaluate_all(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.evaluate_all(expression=expression,
                                                          arg=mapping.to_impl(arg)))
    ...
    async def evaluate_handle(self,
                        ...
                        arg: typing.Optional[typing.Any] = None,
                        *,
                        timeout: typing.Optional[float] = None) -> "JSHandle":
    ...
    async def clear(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.clear(timeout=timeout,
                                                   noWaitAfter=no_wait_after,
                                                   force=force))
    ...
    async def element_handle(self,
                       *,
                       timeout: typing.Optional[float] = None) -> "ElementHandle":
    ...
    def filter(self,
               *,
               ...
               visible: typing.Optional[bool] = None) -> "Locator":
        """Locator.filter
        ...
        **Usage**
        ...
        return mapping.from_impl(self._impl_obj.filter(hasText=has_text,
                                        hasNotText=has_not_text,
                                        has=has._impl_obj if has else None,
                                        hasNot=has_not._impl_obj if has_not else None,
                                        visible=visible))
    ...
    async def drag_to(self,
                ...
                *,
                ...
                trial: typing.Optional[bool] = None,
                source_position: typing.Optional[Position] = None,
                target_position: typing.Optional[Position] = None) -> None:
        """Locator.drag_to
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.drag_to(target=target._impl_obj,
                                                     force=force,
                                                     noWaitAfter=no_wait_after,
                                                     timeout=timeout,
                                                     trial=trial,
    ...
    async def is_disabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_disabled(timeout=timeout))
    ...
    async def is_editable(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.is_editable(timeout=timeout))
    ...
    async def aria_snapshot(self,
                      *,
                      timeout: typing.Optional[float] = None,
                      ref: typing.Optional[bool] = None) -> str:
        ...
        **Details**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.aria_snapshot(timeout=timeout,
                                                           ref=ref))
    ...
    async def text_content(self,
        ...
        **NOTE** If you need to assert text on the page, prefer `locator_assertions.to_have_text()` to avoid
        ...
        return mapping.from_maybe_impl(await self._impl_obj.text_content(timeout=timeout))
    ...
    async def press_sequentially(self,
                           text: str,
                           *,
                           delay: typing.Optional[float] = None,
                           timeout: typing.Optional[float] = None,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.press_sequentially(text=text,
                                                                delay=delay,
                                                                timeout=timeout,
                                                                noWaitAfter=no_wait_after))
    ...
    async def wait_for(self,
                 *,
                 timeout: typing.Optional[float] = None,
                 state: typing.Optional[Literal['attached', 'detached', 'hidden', 'visible']] = None) -> None:
        """Locator.wait_for
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.wait_for(timeout=timeout,
                                                      state=state))
...
class APIRequestContext(AsyncBase):
    ...
    async def delete(self,
               url: str,
               *,
               params: typing.Optional[typing.Union[typing.Dict[str, typing.Union[str, float, bool]], str]] = None,
               headers: typing.Optional[typing.Dict[str, str]] = None,
               ...
               multipart: typing.Optional[typing.Dict[str, typing.Union[bytes, bool, float, str, FilePayload]]] = None,
               timeout: typing.Optional[float] = None,
               fail_on_status_code: typing.Optional[bool] = None,
               ignore_https_errors: typing.Optional[bool] = None,
               max_redirects: typing.Optional[int] = None,
               max_retries: typing.Optional[int] = None) -> "APIResponse":
        ...
        return mapping.from_impl(await self._impl_obj.delete(url=url,
                                              params=mapping.to_impl(params),
                                              headers=mapping.to_impl(headers),
    ...
    async def head(self,
        ...
        return mapping.from_impl(await self._impl_obj.head(url=url,
                                            params=mapping.to_impl(params),
                                            headers=mapping.to_impl(headers),
                                            data=mapping.to_impl(data),
                                            form=mapping.to_impl(form),
    ...
    async def get(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.get(url=url,
                                           params=mapping.to_impl(params),
                                           headers=mapping.to_impl(headers),
                                           data=mapping.to_impl(data),
                                           form=mapping.to_impl(form),
    ...
    async def patch(self,
        ...
        return mapping.from_impl(await self._impl_obj.patch(url=url,
                                             params=mapping.to_impl(params),
                                             headers=mapping.to_impl(headers),
                                             data=mapping.to_impl(data),
                                             form=mapping.to_impl(form),
    ...
    async def put(self,
        ...
        return mapping.from_impl(await self._impl_obj.put(url=url,
                                           params=mapping.to_impl(params),
                                           headers=mapping.to_impl(headers),
                                           data=mapping.to_impl(data),
                                           form=mapping.to_impl(form),
    ...
    async def post(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.post(url=url,
                                            params=mapping.to_impl(params),
                                            headers=mapping.to_impl(headers),
                                            data=mapping.to_impl(data),
                                            form=mapping.to_impl(form),
    ...
    async def fetch(self,
        ...
        **Usage**
        ...
        return mapping.from_impl(await self._impl_obj.fetch(urlOrRequest=url_or_request,
                                             params=mapping.to_impl(params),
                                             method=method,
                                             headers=mapping.to_impl(headers),
                                             data=mapping.to_impl(data),
...
class APIRequest(AsyncBase):
    ...
    async def new_context(self,
                    *,
                    ...
                    fail_on_status_code: typing.Optional[bool] = None,
                    max_redirects: typing.Optional[int] = None) -> "APIRequestContext":
        ...
        return mapping.from_impl(await self._impl_obj.new_context(baseURL=base_url,
                                                   extraHTTPHeaders=mapping.to_impl(extra_http_headers),
                                                   httpCredentials=http_credentials,
                                                   ignoreHTTPSErrors=ignore_https_errors,
                                                   proxy=proxy,
...
class PageAssertions(AsyncBase):
    ...
    async def to_have_title(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_title(titleOrRegExp=title_or_reg_exp,
                                                           timeout=timeout))

    async def not_to_have_title(self,
                          title_or_reg_exp: typing.Union[typing.Pattern[str], str],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_title(titleOrRegExp=title_or_reg_exp,
                                                               timeout=timeout))

    async def to_have_url(self,
                    url_or_reg_exp: typing.Union[str, typing.Pattern[str]],
                    *,
                    timeout: typing.Optional[float] = None,
                    ignore_case: typing.Optional[bool] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_url(urlOrRegExp=url_or_reg_exp,
                                                         timeout=timeout,
                                                         ignoreCase=ignore_case))

    async def not_to_have_url(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_url(urlOrRegExp=url_or_reg_exp,
                                                             timeout=timeout,
                                                             ignoreCase=ignore_case))
...
class LocatorAssertions(AsyncBase):
    ...
    async def to_contain_text(self,
                        expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                        *,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_contain_text(expected=mapping.to_impl(expected),
                                                             useInnerText=use_inner_text,
                                                             timeout=timeout,
                                                             ignoreCase=ignore_case))

    async def not_to_contain_text(self,
                            expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                            *,
                            use_inner_text: typing.Optional[bool] = None,
                            timeout: typing.Optional[float] = None,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_contain_text(expected=mapping.to_impl(expected),
                                                                 useInnerText=use_inner_text,
                                                                 timeout=timeout,
                                                                 ignoreCase=ignore_case))

    async def to_have_attribute(self,
                          name: str,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_attribute(name=name,
                                                               value=value,
                                                               ignoreCase=ignore_case,
                                                               timeout=timeout))

    async def not_to_have_attribute(self,
                              name: str,
                              value: typing.Union[str, typing.Pattern[str]],
                              *,
                              ignore_case: typing.Optional[bool] = None,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_attribute(name=name,
                                                                   value=value,
                                                                   ignoreCase=ignore_case,
                                                                   timeout=timeout))

    async def to_have_class(self,
                      expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_class(expected=mapping.to_impl(expected),
                                                           timeout=timeout))

    async def not_to_have_class(self,
                          expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_class(expected=mapping.to_impl(expected),
                                                               timeout=timeout))

    async def to_contain_class(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_contain_class(expected=mapping.to_impl(expected),
                                                              timeout=timeout))

    async def not_to_contain_class(self,
                             expected: typing.Union[typing.Sequence[str], str],
                             *,
                             timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_contain_class(expected=mapping.to_impl(expected),
                                                                  timeout=timeout))

    async def to_have_count(self,
                      count: int,
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_count(count=count,
                                                           timeout=timeout))

    async def not_to_have_count(self,
                          count: int,
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_count(count=count,
                                                               timeout=timeout))

    async def to_have_css(self,
                    name: str,
                    value: typing.Union[str, typing.Pattern[str]],
                    *,
                    timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_css(name=name,
                                                         value=value,
                                                         timeout=timeout))

    async def not_to_have_css(self,
                        name: str,
                        value: typing.Union[str, typing.Pattern[str]],
                        *,
                        timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_css(name=name,
                                                             value=value,
                                                             timeout=timeout))

    async def to_have_id(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_id(id=id,
                                                        timeout=timeout))

    async def not_to_have_id(self,
                       id: typing.Union[str, typing.Pattern[str]],
                       *,
                       timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_id(id=id,
                                                            timeout=timeout))

    async def to_have_js_property(self,
                            name: str,
                            value: typing.Any,
                            *,
                            timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_js_property(name=name,
                                                                 value=mapping.to_impl(value),
                                                                 timeout=timeout))

    async def not_to_have_js_property(self,
                                name: str,
                                value: typing.Any,
                                *,
                                timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_js_property(name=name,
                                                                     value=mapping.to_impl(value),
                                                                     timeout=timeout))

    async def to_have_value(self,
                      value: typing.Union[str, typing.Pattern[str]],
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_value(value=value,
                                                           timeout=timeout))

    async def not_to_have_value(self,
                          value: typing.Union[str, typing.Pattern[str]],
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_value(value=value,
                                                               timeout=timeout))

    async def to_have_values(self,
                       values: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]]],
                       *,
                       timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_values(values=mapping.to_impl(values),
                                                            timeout=timeout))

    async def not_to_have_values(self,
                           values: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]]],
                           *,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_values(values=mapping.to_impl(values),
                                                                timeout=timeout))

    async def to_have_text(self,
                     expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                     *,
                     use_inner_text: typing.Optional[bool] = None,
                     timeout: typing.Optional[float] = None,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_text(expected=mapping.to_impl(expected),
                                                          useInnerText=use_inner_text,
                                                          timeout=timeout,
                                                          ignoreCase=ignore_case))

    async def not_to_have_text(self,
                         expected: typing.Union[typing.Sequence[str], typing.Sequence[typing.Pattern[str]], typing.Sequence[typing.Union[typing.Pattern[str], str]], typing.Pattern[str], str],
                         *,
                         use_inner_text: typing.Optional[bool] = None,
                         timeout: typing.Optional[float] = None,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_text(expected=mapping.to_impl(expected),
                                                              useInnerText=use_inner_text,
                                                              timeout=timeout,
                                                              ignoreCase=ignore_case))
    ...
    async def to_be_attached(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_attached(attached=attached,
                                                            timeout=timeout))
    ...
    async def to_be_checked(self,
                      *,
                      timeout: typing.Optional[float] = None,
                      checked: typing.Optional[bool] = None,
                      indeterminate: typing.Optional[bool] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_checked(timeout=timeout,
                                                           checked=checked,
                                                           indeterminate=indeterminate))

    async def not_to_be_attached(self,
                           *,
                           attached: typing.Optional[bool] = None,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_attached(attached=attached,
                                                                timeout=timeout))
    ...
    async def not_to_be_checked(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_checked(timeout=timeout))
    ...
    async def to_be_disabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_disabled(timeout=timeout))

    async def not_to_be_disabled(self,
                           *,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_disabled(timeout=timeout))

    async def to_be_editable(self,
                       *,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_editable(editable=editable,
                                                            timeout=timeout))

    async def not_to_be_editable(self,
                           *,
                           editable: typing.Optional[bool] = None,
                           timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_editable(editable=editable,
                                                                timeout=timeout))

    async def to_be_empty(self,
                    *,
                    timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_empty(timeout=timeout))

    async def not_to_be_empty(self,
                        *,
                        timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_empty(timeout=timeout))
    ...
    async def to_be_enabled(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_enabled(enabled=enabled,
                                                           timeout=timeout))

    async def not_to_be_enabled(self,
                          *,
                          enabled: typing.Optional[bool] = None,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_enabled(enabled=enabled,
                                                               timeout=timeout))
    ...
    async def to_be_hidden(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_hidden(timeout=timeout))

    async def not_to_be_hidden(self,
                         *,
                         timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_hidden(timeout=timeout))
    ...
    async def to_be_visible(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_visible(visible=visible,
                                                           timeout=timeout))
    ...
    async def not_to_be_visible(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_visible(visible=visible,
                                                               timeout=timeout))

    async def to_be_focused(self,
                      *,
                      timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_focused(timeout=timeout))

    async def not_to_be_focused(self,
                          *,
                          timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_focused(timeout=timeout))

    async def to_be_in_viewport(self,
                          *,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_be_in_viewport(ratio=ratio,
                                                               timeout=timeout))

    async def not_to_be_in_viewport(self,
                              *,
                              ratio: typing.Optional[float] = None,
                              timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_be_in_viewport(ratio=ratio,
                                                                   timeout=timeout))

    async def to_have_accessible_description(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_accessible_description(description=description,
                                                                            ignoreCase=ignore_case,
                                                                            timeout=timeout))

    async def not_to_have_accessible_description(self,
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_accessible_description(name=name,
                                                                                ignoreCase=ignore_case,
                                                                                timeout=timeout))

    async def to_have_accessible_name(self,
                                name: typing.Union[str, typing.Pattern[str]],
                                *,
                                ignore_case: typing.Optional[bool] = None,
                                timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_accessible_name(name=name,
                                                                     ignoreCase=ignore_case,
                                                                     timeout=timeout))

    async def not_to_have_accessible_name(self,
                                    name: typing.Union[str, typing.Pattern[str]],
                                    *,
                                    ignore_case: typing.Optional[bool] = None,
                                    timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_accessible_name(name=name,
                                                                         ignoreCase=ignore_case,
                                                                         timeout=timeout))

    async def to_have_role(self,
                     role: Literal['alert', 'alertdialog', 'application', 'article', 'banner', 'blockquote', 'button', 'caption', 'cell', 'checkbox', 'code', 'columnheader', 'combobox', 'complementary', 'contentinfo', 'definition', 'deletion', 'dialog', 'directory', 'document', 'emphasis', 'feed', 'figure', 'form', 'generic', 'grid', 'gridcell', 'group', 'heading', 'img', 'insertion', 'link', 'list', 'listbox', 'listitem', 'log', 'main', 'marquee', 'math', 'menu', 'menubar', 'menuitem', 'menuitemcheckbox', 'menuitemradio', 'meter', 'navigation', 'none', 'note', 'option', 'paragraph', 'presentation', 'progressbar', 'radio', 'radiogroup', 'region', 'row', 'rowgroup', 'rowheader', 'scrollbar', 'search', 'searchbox', 'separator', 'slider', 'spinbutton', 'status', 'strong', 'subscript', 'superscript', 'switch', 'tab', 'table', 'tablist', 'tabpanel', 'term', 'textbox', 'time', 'timer', 'toolbar', 'tooltip', 'tree', 'treegrid', 'treeitem'],
                     *,
                     timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_role(role=role,
                                                          timeout=timeout))

    async def to_have_accessible_error_message(self,
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_have_accessible_error_message(errorMessage=error_message,
                                                                              ignoreCase=ignore_case,
                                                                              timeout=timeout))

    async def not_to_have_accessible_error_message(self,
                                             error_message: typing.Union[str, typing.Pattern[str]],
                                             *,
                                             ignore_case: typing.Optional[bool] = None,
                                             timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_accessible_error_message(errorMessage=error_message,
                                                                                  ignoreCase=ignore_case,
                                                                                  timeout=timeout))

    async def not_to_have_role(self,
                         role: Literal['alert', 'alertdialog', 'application', 'article', 'banner', 'blockquote', 'button', 'caption', 'cell', 'checkbox', 'code', 'columnheader', 'combobox', 'complementary', 'contentinfo', 'definition', 'deletion', 'dialog', 'directory', 'document', 'emphasis', 'feed', 'figure', 'form', 'generic', 'grid', 'gridcell', 'group', 'heading', 'img', 'insertion', 'link', 'list', 'listbox', 'listitem', 'log', 'main', 'marquee', 'math', 'menu', 'menubar', 'menuitem', 'menuitemcheckbox', 'menuitemradio', 'meter', 'navigation', 'none', 'note', 'option', 'paragraph', 'presentation', 'progressbar', 'radio', 'radiogroup', 'region', 'row', 'rowgroup', 'rowheader', 'scrollbar', 'search', 'searchbox', 'separator', 'slider', 'spinbutton', 'status', 'strong', 'subscript', 'superscript', 'switch', 'tab', 'table', 'tablist', 'tabpanel', 'term', 'textbox', 'time', 'timer', 'toolbar', 'tooltip', 'tree', 'treegrid', 'treeitem'],
                         *,
                         timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_have_role(role=role,
                                                              timeout=timeout))

    async def to_match_aria_snapshot(self,
                               expected: str,
                               *,
                               timeout: typing.Optional[float] = None) -> None:
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(await self._impl_obj.to_match_aria_snapshot(expected=expected,
                                                                    timeout=timeout))

    async def not_to_match_aria_snapshot(self,
                                   expected: str,
                                   *,
                                   timeout: typing.Optional[float] = None) -> None:
        ...
        return mapping.from_maybe_impl(await self._impl_obj.not_to_match_aria_snapshot(expected=expected,
                                                                        timeout=timeout))
